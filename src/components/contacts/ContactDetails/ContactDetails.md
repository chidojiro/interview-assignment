...
import { ContactDetails } from '@ffw/randstad-shared-components';
 const profiles = [
  ...
  <ContactDetails type="contact-person" title="get in touch" description="We are here to help you with your press questions" profiles={profiles} backgroundClass="bg-variant-brand-tertiary" />
  ```
...
ContactDetails component with "meet-the-team" variant with tertiary background.
  ```jsx
import { ContactDetails } from '@ffw/randstad-shared-components';
 const profiles = [
   {
  ...
  <ContactDetails type="meet-the-team" title="meet the team" description="We are here to help you with your press questions" profiles={profiles} backgroundClass="bg-variant-brand-tertiary" />
  ```
